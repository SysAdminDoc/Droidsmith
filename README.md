...
![Version](https://img.shields.io/badge/version-0.9.13-cyan)
...
The source tree and manifests are version `0.9.13`. As checked on 2026-07-31,
...
|---|---|
| Droidsmith source/manifests | `0.9.13` |
