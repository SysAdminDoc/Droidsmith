...
use commands::{
    ...
    list_network_connections, list_packages, list_packs, list_permissions,
    list_process_exit_history, list_processes, list_remote_files, list_running_services,
    list_users, list_wireless_debugging_risks, list_wireless_history, list_wireless_services,
    locate_fastboot, locate_gnirehtet, locate_scrcpy, observe_device_fingerprint,
    open_artifact_with, open_repository, pair_wireless, perfetto_capabilities, plan_action,
